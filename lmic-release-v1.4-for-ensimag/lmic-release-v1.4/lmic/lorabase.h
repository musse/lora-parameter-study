...
enum { DELAY_JACC2       =  2 }; // modifier de 6 a 2   DELAY_JACC1+(int)DELAY_EXTDNW2 }; // in secs
enum { DELAY_DNW2        =  0 }; // modifier de 1 a 0   DELAY_DNW1 +(int)DELAY_EXTDNW2 }; // in secs down window #1
enum { BCN_INTV_exp      = 7 };
...
enum { EU868_F1 = 868100000,      // g1   SF7-12 
       ...
       EU868_J5 = 868300000,      // g2   SF7-12   ditto
