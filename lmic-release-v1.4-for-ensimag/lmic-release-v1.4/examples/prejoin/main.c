...
static const u4_t NETID=0xBB1CAF;
	
static const devaddr_t DEVADDR = 0x12345677;
	
static const u1_t NWKKEY[16] = { 0x01, 0x89, 0xEF, 0xCD, 0x23, 0x01, 0x67, 0x45, 0x54, 0x76, 0x10, 0x32, 0xDC, 0xFE, 0x98, 0xBA };

static const u1_t ARTKEY[16] = { 0x02, 0x89, 0xEF, 0xCD, 0x23, 0x01, 0x67, 0x45, 0x54, 0x76, 0x10, 0x32, 0xDC, 0xFE, 0x98, 0xBA };
...
static void reportfunc (osjob_t* j) {
    ...
    os_setTimedCallback(j, os_getTime()+sec2osticks(REPORTPERIOD), reportfunc);
}
